...
<div class="container mx-auto px-4 py-8" x-data="{ showDeleteConfirmModal: false, deleteFormAction: '' }">
    <div class="bg-white rounded-2xl shadow-xl p-6 md:p-8">
        <div class="flex justify-between items-center mb-6">
            <h2 class="text-3xl font-bold text-gray-800">Notas de Salida</h2>
            <a href="{{ route('nota_salidas.create') }}" class="bg-blue-600 hover:bg-blue-700 text-white font-semibold py-2 px-4 rounded-xl shadow-md">Nueva Nota</a>
        </div>
            ...
            <tbody class="divide-y divide-gray-200">
                ...
                <tr>
                    ...
                    <td class="px-4 py-2 space-x-2">
                        <a href="{{ route('nota_salidas.show', $nota) }}" class="text-blue-600 hover:text-blue-900">Ver</a>
                        <button @click="showDeleteConfirmModal = true; deleteFormAction = '{{ route('nota_salidas.destroy', $nota) }}'" class="text-red-600 hover:text-red-900">Eliminar</button>
                    </td>
                </tr>
                @empty
                <tr>
